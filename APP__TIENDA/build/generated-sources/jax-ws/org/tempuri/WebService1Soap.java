...
public interface WebService1Soap {
    ...
    @RequestWrapper(localName = "CrearCliente", targetNamespace = "http://tempuri.org/", className = "org.tempuri.CrearCliente")
    @ResponseWrapper(localName = "CrearClienteResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.CrearClienteResponse")
    ...
    @RequestWrapper(localName = "ActualizarProducto", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ActualizarProducto")
    @ResponseWrapper(localName = "ActualizarProductoResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ActualizarProductoResponse")
    ...
    @RequestWrapper(localName = "ActualizarPedido", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ActualizarPedido")
    @ResponseWrapper(localName = "ActualizarPedidoResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ActualizarPedidoResponse")
    ...
    @RequestWrapper(localName = "ConsultaCliente", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ConsultaCliente")
    @ResponseWrapper(localName = "ConsultaClienteResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ConsultaClienteResponse")
    ...
    @RequestWrapper(localName = "CrearPedidos", targetNamespace = "http://tempuri.org/", className = "org.tempuri.CrearPedidos")
    @ResponseWrapper(localName = "CrearPedidosResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.CrearPedidosResponse")
    ...
    @RequestWrapper(localName = "ConsultaPedidos", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ConsultaPedidos")
    @ResponseWrapper(localName = "ConsultaPedidosResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ConsultaPedidosResponse")
    ...
    @RequestWrapper(localName = "ConsultaProducto", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ConsultaProducto")
    @ResponseWrapper(localName = "ConsultaProductoResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ConsultaProductoResponse")
    ...
    @RequestWrapper(localName = "ReporteDeQuejasOComenterios", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ReporteDeQuejasOComenterios")
    @ResponseWrapper(localName = "ReporteDeQuejasOComenteriosResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ReporteDeQuejasOComenteriosResponse")
    ...
    @RequestWrapper(localName = "A\u00f1adirComentario", targetNamespace = "http://tempuri.org/", className = "org.tempuri.A\u00f1adirComentario")
    @ResponseWrapper(localName = "A\u00f1adirComentarioResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.A\u00f1adirComentarioResponse")
    ...
    @RequestWrapper(localName = "ConsultaPuntajeComentariosOQuejas", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ConsultaPuntajeComentariosOQuejas")
    @ResponseWrapper(localName = "ConsultaPuntajeComentariosOQuejasResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ConsultaPuntajeComentariosOQuejasResponse")
    ...
    @RequestWrapper(localName = "AgregarProducto", targetNamespace = "http://tempuri.org/", className = "org.tempuri.AgregarProducto")
    @ResponseWrapper(localName = "AgregarProductoResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.AgregarProductoResponse")
    ...
    @RequestWrapper(localName = "ReporteStockProducto", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ReporteStockProducto")
    @ResponseWrapper(localName = "ReporteStockProductoResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ReporteStockProductoResponse")
    ...
    @RequestWrapper(localName = "ClientesFrecuentes", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ClientesFrecuentes")
    @ResponseWrapper(localName = "ClientesFrecuentesResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ClientesFrecuentesResponse")
    ...
    @RequestWrapper(localName = "ListaDePedidosPorCodigo", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ListaDePedidosPorCodigo")
    @ResponseWrapper(localName = "ListaDePedidosPorCodigoResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ListaDePedidosPorCodigoResponse")
    ...
    @RequestWrapper(localName = "ListaDePedidosOCompras", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ListaDePedidosOCompras")
    @ResponseWrapper(localName = "ListaDePedidosOComprasResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ListaDePedidosOComprasResponse")
    ...
    @RequestWrapper(localName = "ReporteDeClientes", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ReporteDeClientes")
    @ResponseWrapper(localName = "ReporteDeClientesResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ReporteDeClientesResponse")
    ...
    @RequestWrapper(localName = "ReporteDeVentasFinalizado", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ReporteDeVentasFinalizado")
    @ResponseWrapper(localName = "ReporteDeVentasFinalizadoResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ReporteDeVentasFinalizadoResponse")
    ...
    @RequestWrapper(localName = "ReporteDeVentasProceso", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ReporteDeVentasProceso")
    @ResponseWrapper(localName = "ReporteDeVentasProcesoResponse", targetNamespace = "http://tempuri.org/", className = "org.tempuri.ReporteDeVentasProcesoResponse")
